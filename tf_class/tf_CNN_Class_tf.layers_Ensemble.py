...
# 1개 filter (2,2,1,1) with padding: VALID
...
# 1개 filter (2,2,1,1) with padding:SAME
...
W3 = tf.get_variable("wccc3", shape=[7 * 7 * 64, 10], initializer=tf.contrib.layers.xavier_initializer())
